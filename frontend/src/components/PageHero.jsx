...
// id="page-hero" is the marker the shared Header (see Header.jsx) observes
// to know when this page's hero has scrolled out from under it — every
// public page that renders Header renders a hero with this id, either
// this component or Home.jsx's own hero section.
export default function PageHero({ title, eyebrow = 'KDCCE', text, image = '/images/hero.jpg' }) {
  return <section id="page-hero" className="relative overflow-hidden bg-kGreen">
    ...
    <div className="container-k relative pb-20 pt-28 text-white md:pb-28 md:pt-36">
