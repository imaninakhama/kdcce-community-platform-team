  ...
  return <footer className="mt-20 bg-[#0b1721] text-white">
    <div className="container-k grid gap-12 py-14 md:grid-cols-[1.2fr_.8fr_.9fr_1fr]">
      <div>
        ...
        <div className="mt-5 flex gap-3"><a href="#" aria-label="Facebook" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[#FF6FA8]"><Facebook size={15}/></a><a href="#" aria-label="Instagram" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[#FF6FA8]"><Instagram size={15}/></a><a href="#" aria-label="Twitter" className="grid h-9 w-9 place-items-center rounded-full border border-white/15 hover:border-[#FF6FA8]"><Twitter size={15}/></a></div>
      </div>
      <div><h4 className="mb-5 font-display text-lg">Quick Links</h4><div className="grid gap-3 text-sm text-white/65"><Link to="/about">About Us</Link><Link to="/programs">Programs</Link><Link to="/gallery">Gallery</Link></div></div>
      ...
      <div><h4 className="mb-5 font-display text-lg">Contact Us</h4><div className="grid gap-4 text-sm text-white/65"><div className="flex gap-3"><Phone size={16} className="mt-1 text-[#FF6FA8]"/><a href="tel:+254796755846" className="hover:text-white">+254 796 755 846</a></div><div className="flex gap-3"><Mail size={16} className="mt-1 text-[#FF6FA8]"/><span>info@kdcce.org</span></div><div className="flex gap-3"><MapPin size={16} className="mt-1 text-[#FF6FA8]"/><span>Kibera, Nairobi, Kenya</span></div></div></div>
    </div>
